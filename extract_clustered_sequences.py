with open("./data/misc/red_full.txt", 'r', encoding="utf8") as in_f:
    with open("./data/misc/red_full_processed.txt", 'w') as out_f:
        filedata = in_f.read()
        ...
        for line in split_filedata:
            if line.startswith('>') and not line.startswith('>PRoBERta'):
                label_lines += 1
